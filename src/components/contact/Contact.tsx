...
function Contact() {
  ...
  return (
    <div className="flex flex-col p-4 m-4 space-y-3" id="contact">
      ...
      <p>
        Contact me at{" "}
        <Link to={`mailto:${contactEmail}`} className="text-green-600">
          {contactEmail}
        </Link>{" "}
        for frontend development opportunities and open-source projects
        collaboration in GIS. Looking forward to hearing from you! Looking
